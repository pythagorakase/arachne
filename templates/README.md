...
ballot; three candidates yield all three pairwise ballots on the same pose page.
The matchup order and left/right assignment are randomized once at build time
and preserved in a private provenance sidecar.
